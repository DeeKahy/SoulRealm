...
A)
At a minimum it is 11 minutes because it can stay in rest for 10 before getting kicked off, and then work once every 4 minutes (y kicks it into hit), afterwhich it rests for another 10 minutes, and then works for the remanining 10 minutes (every 4 minutes it does a hit)
