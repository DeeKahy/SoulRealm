## **SIDE 1 (Front): Presentation Flow** ==why not also whitebox==
...
```
80 tests takes leap years into account and is a lot less than $31*12$ (372) and that doesnt take years or leap years into account. If we include the 68 years apple allows you to select from (2069-2001) it suddenly turns into a little over 25.000 tests.
### **Bottom Strip:**
