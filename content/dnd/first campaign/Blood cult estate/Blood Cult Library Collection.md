...
- **"Elvish Delicacies: The Forest's Forbidden Feast"**
- **"Dwarven Dishes: Tough Meat, Tender Preparation"**
- **"The Perfect Pairing: Wines to Complement Your Humanoid Meal"**
- **"To Serve Halfling: Small Portions with Big Flavor"**

## Cult Knowledge & Trivia
...
- **"The Crimson Path: Beginners Guide to Blood Worship"**
- **"Binding the Unwilling: Ritual Restraint Techniques"**
- **"Chants to the Crimson God: A Songbook"** (blood-stained pages)
- **"Hidden in Plain Sight: Maintaining Your Cult in Civilized Society"**

## Navigation
- **"Desert Stars: Navigating the Endless Sands by Night"** (this book appears newer than the others, with a detailed star chart tucked between its pages)
